# CIFAR100 10 closed + 10 open
    # ImageLevelGAN
        ...
        # Background player GAN
            ...
            # python train.py CIFAR100 --verbose True --log_first_round True --init_mode open_set_leave_one_out --writer False --save_ckpt False --data_path ./data --trainer gan --gan_player multiple --gan_mode ImageLevelGAN --gan_setup 100_epochs --batch 32 --arch ResNet50 --lr 0.1 --uncertainty_measure least_confident --pretrained CIFAR10 --epochs 20 --gan_multi highest --save_gan_output True;
            # python train.py CIFAR100 --verbose True --log_first_round True --init_mode open_set_leave_one_out --writer False --save_ckpt False --data_path ./data --trainer gan --gan_player multiple --gan_mode ImageLevelGAN --gan_setup 100_epochs --batch 32 --arch ResNet50 --lr 0.1 --uncertainty_measure least_confident --pretrained CIFAR10 --epochs 20 --gan_multi lowest --save_gan_output True;
            # python train.py CIFAR100 --verbose True --log_first_round True --init_mode open_set_leave_one_out --writer False --save_ckpt False --data_path ./data --trainer gan --gan_player single --gan_mode ImageLevelGAN --gan_setup 100_epochs --batch 32 --arch ResNet50 --lr 0.1 --uncertainty_measure least_confident --pretrained CIFAR10 --epochs 20 --save_gan_output True;
    ...
    # Sigmoid Uncertainty 
        # Threshold 0.5 + mean
            python train.py CIFAR100 --verbose False --log_first_round True --init_mode open_set_leave_one_out --writer False --save_ckpt False --data_path ./data --trainer sigmoid --batch 32 --network_eval_threshold 0.5 --arch ResNet50 --lr 0.1 --epochs 50 --uncertainty_measure least_confident --pretrained CIFAR10 --sigmoid_train_mode mean;
        # Threshold 0.5 + sum
            python train.py CIFAR100 --verbose False --log_first_round True --init_mode open_set_leave_one_out --writer False --save_ckpt False --data_path ./data --trainer sigmoid --batch 32 --network_eval_threshold 0.5 --arch ResNet50 --lr 0.1 --epochs 50 --uncertainty_measure least_confident --pretrained CIFAR10 --sigmoid_train_mode sum;
